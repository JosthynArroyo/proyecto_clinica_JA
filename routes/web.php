...
use App\Http\Controllers\Paciente\AdminController as PacientePanelController;
use App\Http\Controllers\Doctor\AdminController as DoctorPanelController;
...
use App\Http\Controllers\DashboardAdministrativoController;
...
Route::get('/especialidades/{especialidad}/doctores', [AdminPanelController::class, 'doctoresPorEspecialidad'])
...
Route::middleware(['auth', 'role:administrador'])->prefix('admin')->group(function () {
    // Dashboard
    Route::get('/dashboard', [DashboardAdministrativoController::class, 'index'])->name('admin.dashboard');
    Route::get('/dashboard/resumen', [DashboardAdministrativoController::class, 'resumen'])->name('admin.dashboard.resumen');

    // Perfil
    Route::get('/perfil', [AdminPanelController::class, 'editarPerfil'])->name('admin.perfil.edit');
    Route::post('/perfil', [AdminPanelController::class, 'actualizarPerfil'])->name('admin.perfil.update');

    // Usuarios (módulo completo)
    Route::get('/usuarios', [AdminPanelController::class, 'usuarios'])->name('admin.usuarios.index');
    Route::get('/usuarios/crear', [AdminPanelController::class, 'usuariosCreate'])->name('admin.usuarios.create');
    Route::post('/usuarios', [AdminPanelController::class, 'usuariosStore'])->name('admin.usuarios.store');
    Route::get('/usuarios/{user}', [AdminPanelController::class, 'usuariosShow'])->name('admin.usuarios.show');
    Route::get('/usuarios/{user}/editar', [AdminPanelController::class, 'usuariosEdit'])->name('admin.usuarios.edit');
    Route::put('/usuarios/{user}', [AdminPanelController::class, 'usuariosUpdate'])->name('admin.usuarios.update');
    Route::delete('/usuarios/{user}', [AdminPanelController::class, 'usuariosDestroy'])->name('admin.usuarios.destroy');

    // Exportes
    Route::get('/usuarios/export/excel', [AdminPanelController::class, 'usuariosExportExcel'])->name('admin.usuarios.export.excel');
    Route::get('/usuarios/export/pdf',   [AdminPanelController::class, 'usuariosExportPdf'])->name('admin.usuarios.export.pdf');
    ...
    // Doctores
    Route::get('/doctores/crear', [AdminPanelController::class, 'crearDoctor'])->name('admin.doctores.crear');
    Route::post('/doctores', [AdminPanelController::class, 'storeDoctor'])->name('admin.doctores.store');

    // Pacientes
    Route::get('/pacientes/crear', [AdminPanelController::class, 'crearPaciente'])->name('admin.pacientes.crear');
    Route::post('/pacientes', [AdminPanelController::class, 'storePaciente'])->name('admin.pacientes.store');
...
Route::middleware(['auth', 'role:paciente'])->prefix('paciente')->group(function () {
    Route::get('/dashboard', [PacientePanelController::class, 'dashboard'])->name('paciente.dashboard');
    Route::get('/perfil', [PacientePanelController::class, 'editarPerfil'])->name('paciente.perfil.edit');
    Route::post('/perfil', [PacientePanelController::class, 'actualizarPerfil'])->name('paciente.perfil.update');
...
Route::middleware(['auth', 'role:doctor'])->prefix('doctor')->group(function () {
    Route::get('/dashboard', [DashboardDoctorController::class, 'index'])->name('doctor.dashboard');
    Route::get('/dashboard/data', [DashboardDoctorController::class, 'data'])->name('doctor.dashboard.data');
    Route::get('/perfil', [DoctorPanelController::class, 'editarPerfil'])->name('doctor.perfil.edit');
    Route::post('/perfil', [DoctorPanelController::class, 'actualizarPerfil'])->name('doctor.perfil.update');
